(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material'), require('@angular/router'), require('@angular/common/http'), require('rxjs/operators'), require('@angular/forms'), require('moment-timezone'), require('ng-recaptcha'), require('algoliasearch'), require('rxjs'), require('@angular/common'), require('@townscript/elements'), require('ng2-tel-input'), require('moment')) :
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/material', '@angular/router', '@angular/common/http', 'rxjs/operators', '@angular/forms', 'moment-timezone', 'ng-recaptcha', 'algoliasearch', 'rxjs', '@angular/common', '@townscript/elements', 'ng2-tel-input', 'moment'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.material, global.ng.router, global.ng.common.http, global.rxjs.operators, global.ng.forms, global.moment$2, global.ngRecaptcha, global.algoliaSearchImported, global.rxjs, global.ng.common, global.elements, global.ng2TelInput, global.moment_));
}(this, function (exports, core, material, router, http, operators, forms, moment$2, ngRecaptcha, algoliaSearchImported, rxjs, common, elements, ng2TelInput, moment_) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TsLoginSignupComponent = /** @class */ (function () {
        function TsLoginSignupComponent(apiService, http$1, fb, cookieService) {
            var _this = this;
    ...
    var LayoutModule = /** @class */ (function () {
        ...
        LayoutModule = __decorate([
            core.NgModule({
                ...
                providers: [TimeService, common.DatePipe, ApiService, CookieService, HeaderService]
            })
        ], LayoutModule);
        return LayoutModule;
    }());
    ...
    exports.ɵc = LoginTopContentComponent;
    exports.ɵd = RangeDatePipe;
