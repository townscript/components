(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('algoliasearch'), require('rxjs'), require('rxjs/operators'), require('moment-timezone'), require('@angular/common/http'), require('@angular/router'), require('moment'), require('@townscript/elements'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/common', 'algoliasearch', 'rxjs', 'rxjs/operators', 'moment-timezone', '@angular/common/http', '@angular/router', 'moment', '@townscript/elements', '@angular/forms'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.common, global.algoliaSearchImported, global.rxjs, global.rxjs.operators, global.momentImported, global.ng.common.http, global.ng.router, global.moment_, global.elements, global.ng.forms));
}(this, function (exports, core, common, algoliaSearchImported, rxjs, operators, momentImported, http, router, moment_, elements, forms) { 'use strict';
