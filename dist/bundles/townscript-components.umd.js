...
<<<<<<< HEAD
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('algoliasearch'), require('rxjs'), require('rxjs/operators'), require('moment-timezone'), require('@angular/forms'), require('@townscript/elements')) :
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/common', 'algoliasearch', 'rxjs', 'rxjs/operators', 'moment-timezone', '@angular/forms', '@townscript/elements'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.common, global.algoliaSearchImported, global.rxjs, global.rxjs.operators, global.momentImported, global.ng.forms, global.elements));
}(this, function (exports, core, common, algoliaSearchImported, rxjs, operators, momentImported, forms, elements) { 'use strict';
=======
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('algoliasearch'), require('rxjs'), require('rxjs/operators'), require('moment-timezone'), require('@angular/common/http'), require('moment'), require('@townscript/elements'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/common', '@angular/router', 'algoliasearch', 'rxjs', 'rxjs/operators', 'moment-timezone', '@angular/common/http', 'moment', '@townscript/elements', '@angular/forms'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.common, global.ng.router, global.algoliaSearchImported, global.rxjs, global.rxjs.operators, global.momentImported, global.ng.common.http, global.moment_, global.elements, global.ng.forms));
}(this, function (exports, core, common, router, algoliaSearchImported, rxjs, operators, momentImported, http, moment_, elements, forms) { 'use strict';
...
>>>>>>> 07f57e85b8effbe501dcbd4b75bd1760319195d6
    ...
    var SearchComponent = /** @class */ (function () {
        function SearchComponent(timeService, datepipe) {
            var _this = this;
...
<<<<<<< HEAD
            this.toggleCityPopup = function () {
                var cityInputElement = document.getElementById("cityInput");
                if (document.activeElement == cityInputElement) {
                    _this.citySearchActive = true;
                    _this.activeCityBackup = _this.activeCity;
                    _this.activeCity = '';
                    _this.searchActive = false;
                }
                else {
                    _this.citySearchActive = false;
                    _this.setCityOnEmpty();
                }
            };
            this.setCityOnEmpty = function () {
                console.log("Changed");
                if (_this.activeCity.trim() == "" || _this.activeCity == undefined) {
                    _this.activeCity = _this.activeCityBackup;
                }
            };
=======
>>>>>>> 07f57e85b8effbe501dcbd4b75bd1760319195d6
...
>>>>>>> 07f57e85b8effbe501dcbd4b75bd1760319195d6
            ...
            __metadata("design:paramtypes", [TimeService, common.DatePipe])
        ], SearchComponent);
...
>>>>>>> 07f57e85b8effbe501dcbd4b75bd1760319195d6
                ...
                providers: [TimeService, common.DatePipe]
            })
        ], LayoutModule);
        return LayoutModule;
    }());
