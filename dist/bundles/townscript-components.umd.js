(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material'), require('@angular/common/http'), require('rxjs/operators'), require('@angular/forms'), require('moment-timezone'), require('ng-recaptcha'), require('rxjs'), require('@angular/material/dialog'), require('algoliasearch'), require('@angular/common'), require('@townscript/elements'), require('moment'), require('@angular/material/core'), require('intl-tel-input-ng')) :
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/material', '@angular/common/http', 'rxjs/operators', '@angular/forms', 'moment-timezone', 'ng-recaptcha', 'rxjs', '@angular/material/dialog', 'algoliasearch', '@angular/common', '@townscript/elements', 'moment', '@angular/material/core', 'intl-tel-input-ng'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.material, global.ng.common.http, global.rxjs.operators, global.ng.forms, global.moment$2, global.ngRecaptcha, global.rxjs, global.ng.material.dialog, global.algoliaSearchImported, global.ng.common, global.elements, global.moment_, global.ng.material.core, global.intlTelInputNg));
}(this, function (exports, core, material, http, operators, forms, moment$2, ngRecaptcha, rxjs, dialog, algoliaSearchImported, common, elements, moment_, core$1, intlTelInputNg) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TsLoginSignupComponent = /** @class */ (function () {
        function TsLoginSignupComponent(apiService, http$1, fb, cookieService, userService, dialogRef) {
            var _this = this;
