(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/material', '@angular/common/http', 'rxjs/operators', '@angular/forms', 'moment-timezone', 'ng-recaptcha', 'rxjs', '@angular/material/dialog', 'algoliasearch', '@angular/common', '@townscript/elements', 'moment', '@angular/material/core'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.material, global.ng.common.http, global.rxjs.operators, global.ng.forms, global.moment$2, global.ngRecaptcha, global.rxjs, global.ng.material.dialog, global.algoliaSearchImported, global.ng.common, global.elements, global.moment_, global.ng.material.core));
}(this, function (exports, core, material, http, operators, forms, moment$2, ngRecaptcha, rxjs, dialog, algoliaSearchImported, common, elements, moment_, core$1) { 'use strict';
