(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material'), require('@angular/common/http'), require('rxjs/operators'), require('@angular/forms'), require('luxon'), require('ng-recaptcha'), require('rxjs'), require('@angular/common'), require('algoliasearch'), require('@townscript/elements'), require('@angular/material/core'), require('@angular/material/snack-bar'), require('@angular/material/dialog')) :
    typeof define === 'function' && define.amd ? define('@townscript/components', ['exports', '@angular/core', '@angular/material', '@angular/common/http', 'rxjs/operators', '@angular/forms', 'luxon', 'ng-recaptcha', 'rxjs', '@angular/common', 'algoliasearch', '@townscript/elements', '@angular/material/core', '@angular/material/snack-bar', '@angular/material/dialog'], factory) :
    (global = global || self, factory((global.townscript = global.townscript || {}, global.townscript.components = {}), global.ng.core, global.ng.material, global.ng.common.http, global.rxjs.operators, global.ng.forms, global.luxon, global.ngRecaptcha, global.rxjs, global.ng.common, global.algoliaSearchImported, global.elements, global.ng.material.core, global.ng.material['snack-bar'], global.ng.material.dialog));
}(this, function (exports, core, material, http, operators, forms, luxon, ngRecaptcha, rxjs, common, algoliaSearchImported, elements, core$1, snackBar, dialog) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var CitySearchPopupComponent = /** @class */ (function () {
        function CitySearchPopupComponent(headerService, timeService, datepipe) {
            ...
            this.datepipe = datepipe;
            this.showArrow = true;
            this.activeCityChange = new core.EventEmitter();
    ...
    exports.ɵg = AppPasswordDirective;
