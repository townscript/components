...
import { Component, Injectable, Inject, PLATFORM_ID, InjectionToken, Input, ViewChild, ElementRef, HostListener, Output, EventEmitter, Pipe, Directive, NgModule } from '@angular/core';
import { MatDialogConfig, MatDialog, MatSnackBarConfig, MatSnackBar, MAT_DIALOG_DATA, MatDialogRef as MatDialogRef$1 } from '@angular/material';
