...
import { Injectable, Inject, PLATFORM_ID, InjectionToken, ViewChild, Component, Input, ElementRef, HostListener, EventEmitter, Output, Pipe, NgModule } from '@angular/core';
import { MatSnackBarConfig, MatSnackBar, MatDialogConfig, MatDialog, MAT_DIALOG_DATA, MatDialogRef as MatDialogRef$1 } from '@angular/material';
