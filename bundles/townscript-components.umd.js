(function (global, factory) {
    ...
    var TsFooterComponent = /** @class */ (function () {
        ...
        TsFooterComponent.propDecorators = {
            source: [{ type: core.Input, args: ["source",] }],
            popularEvents: [{ type: core.Input, args: ["popularEvents",] }],
            recentBlogs: [{ type: core.Input, args: ["recentBlogs",] }],
            popularReads: [{ type: core.Input, args: ["popularReads",] }]
        };
